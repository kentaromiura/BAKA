...
function copyBoolDict(dict) {
  return (Object.assign({}, dict));
}

function clearFileLineKeys(dict, fileName) {
  ((((dict, fileName) => {
...
function buildSelectedPatch(fileDiffs, selectedFiles, excludedLines) {
  return (((fileDiffs, selectedFiles, excludedLines) => {
...
function syncExcludedLineHighlights(root, excludedLines) {
  return (((root, excludedLines) => {
    if (root == null) return () => {};
...
function syncLineNumberSelection(root, fileName, enabled, setExcludedLines) {
  return (((root, fileName, enabled, setExcludedLines) => {
